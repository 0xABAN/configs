...
local c = {
  ...
  paleOak = "#DCC9B6",
  ash = "#ABC4AB",
  cyan = "#AFE1EB", -- build-mode gradient mid
  creamPeach = "#ffd8c4",
...
hi("Visual", { fg = c.block, bg = c.cream })
...
hi("String", { fg = c.paleOak }) -- syntaxString
hi("Character", { fg = c.paleOak })
hi("Number", { fg = c.cream }) -- syntaxNumber
hi("Float", { fg = c.cream })
hi("Boolean", { fg = c.ash })
hi("Type", { fg = c.cyan }) -- syntaxType
