...
color("Number", "fg", "c7b777")
color("Float", "fg", "c7b777")
color("@number", "fg", "c7b777")
color("@number.float", "fg", "c7b777")
color("Type", "fg", "5FA876")
color("@type", "fg", "5FA876")
color("@type.builtin", "fg", "5FA876")
color("@lsp.type.type", "fg", "5FA876")
color("@lsp.type.function", "fg", "439187")
color("@lsp.type.variable", "fg", "dedec5")
color("@lsp.type.number", "fg", "c7b777")
color("LspReferenceText", "fg", "A8D86E")
color("LspReferenceRead", "fg", "A8D86E")
color("LspReferenceWrite", "fg", "A8D86E")
color("LspReferenceTarget", "fg", "A8D86E")
color("LspInlayHint", "fg", "A8D86E")
color("LspCodeLens", "fg", "A8D86E")
color("LspCodeLensSeparator", "fg", "A8D86E")
color("LspSignatureActiveParameter", "fg", "A8D86E")
color("Visual", "fg", "ffffff")
color("VisualNOS", "fg", "ffffff")
color("PmenuSel", "fg", "ffffff")
color("WinSeparator", "fg", "ffffff")
color("SnacksDashboardDesc", "fg", "ffffff")
color("SnacksDashboardIcon", "fg", "ffffff")
color("SnacksDashboardKey", "fg", "ffffff")
color("Directory", "fg", "439187")
color("FloatBorder", "fg", "326d65")
color("MatchParen", "fg", "ffffff")
color("MatchParen", "bg", "A8D86E")
color("Function", "fg", "439187")
color("@keyword", "fg", "439187")
color("Boolean", "fg", "439187")
color("Underlined", "fg", "439187")
...
color("DiagnosticWarn", "fg", "5FA876")
color("Visual", "bg", "A8D86E")
color("VisualNOS", "bg", "A8D86E")
...
assert(terminal:find("palette = 3=#5FA876", 1, true))
...
assert(pi_color("syntaxKeyword") == "#439187") -- Pi keeps its teal syntax palette.
...
assert(pi_color("syntaxNumber") == "#c7b777")
assert(pi_color("syntaxType") == "#5FA876")
assert(pi_color("warning") == "#5FA876")
