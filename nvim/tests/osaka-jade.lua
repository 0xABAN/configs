...
color("@keyword", "fg", "669987")
color("Boolean", "fg", "669987")
color("DiagnosticInfo", "fg", "669987")
color("TabLineSel", "fg", "669987")
...
assert(terminal:find("palette = 6=#669987", 1, true))
assert(terminal:find("palette = 2=#5fa876", 1, true))
...
assert(pi_color("syntaxKeyword") == "#669987")
assert(pi_color("accent") == "#669987")
assert(pi_color("borderAccent") == "#669987")
assert(pi_color("border") == "#5e9e80")
assert(pi_color("success") == "#5fa876")
assert(pi_color("toolDiffAdded") == "#5fa876")
