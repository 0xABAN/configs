...
color("LspReferenceText", "fg", "51AEA2")
color("LspReferenceRead", "fg", "51AEA2")
color("LspReferenceWrite", "fg", "51AEA2")
color("LspReferenceTarget", "fg", "51AEA2")
color("LspInlayHint", "fg", "51AEA2")
color("LspCodeLens", "fg", "51AEA2")
color("LspCodeLensSeparator", "fg", "51AEA2")
color("LspSignatureActiveParameter", "fg", "51AEA2")
...
color("Cursor", "fg", "ffffff")
color("Cursor", "bg", "51AEA2")
